...
export const ABOUT = {
  ...
  facts: [
    ...
    { label: 'Focus', value: 'Design, motion, real-time' },
    { label: 'Availability', value: 'Select projects — 2026' },
  ],
  tools: ['After Effects', 'Premiere Pro', 'Photoshop', 'Illustrator', 'Figma', 'Blender', 'Three.js'],
};
